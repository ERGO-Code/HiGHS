...
#ifdef HIPO_EXTRAS_LIBRARY_BUILD
#define HIPO_EXTRAS_API __declspec(dllexport)
#else
#define HIPO_EXTRAS_API __declspec(dllimport)
#endif
#else
#define HIPO_EXTRAS_API __attribute__((visibility("default")))
#endif
