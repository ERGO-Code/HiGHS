...
TEST_CASE("test-fourier-motzkin", "[highs_test_presolve_rules]") {
  ...
  HighsInt require_presolved_model_num_col = 0;
  HighsInt require_presolved_model_num_row = 0;
  HighsInt require_presolved_model_num_nz = 0;
  if (zero_cost) {
    lp.col_cost_.assign(lp.num_col_, 0);
  } else {
    lp.col_cost_ = {1, 2, 3, 4};
    require_presolved_model_num_col = 1;
    require_presolved_model_num_row = 8;
    require_presolved_model_num_nz = 8;
  }
  lp.col_lower_.assign(lp.num_col_, 0);
