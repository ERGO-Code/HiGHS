...
TEST_CASE("internal-options", "[highs_options]") {
  ...
  return_status = setLocalOptionValue(options.log_options, "mps_parser_type_free",
  ...
  return_status =
      setLocalOptionValue(options.log_options, "allowed_simplex_matrix_scale_factor",
                     options.records, -1);
  REQUIRE(return_status == OptionStatus::ILLEGAL_VALUE);
  ...
  return_status = getLocalOptionValue(options.log_options, "mps_parser_type_free",
  ...
  return_status =
      getLocalOptionValue(options.log_options, "allowed_simplex_matrix_scale_factor",
