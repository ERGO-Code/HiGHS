...
TEST_CASE("filereader-dualize", "[highs_data]") {
  ...
  Highs highs_lp;
  if (use_ekk) REQUIRE(highs_lp.setHighsOptionValue("simplex_class_ekk", true) ==
          HighsStatus::OK);
  if (!dev_run) {
  ...
  Highs highs_primal;
  if (use_ekk) REQUIRE(highs_primal.setHighsOptionValue("simplex_class_ekk", true) ==
          HighsStatus::OK);
  if (!dev_run) {
  ...
  REQUIRE(status == HighsStatus::OK);
  Highs highs_dual;
  if (use_ekk) REQUIRE(highs_dual.setHighsOptionValue("simplex_class_ekk", true) ==
          HighsStatus::OK);
  if (!dev_run) {
