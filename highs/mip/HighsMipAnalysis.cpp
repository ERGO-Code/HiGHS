...
void HighsMipAnalysis::mipTimerStart(const HighsInt mip_clock,
  ...
  thread_mip_clocks[thread_id].timer_pointer_->start(highs_timer_clock);
}
...
void HighsMipAnalysis::mipTimerStop(const HighsInt mip_clock,
  ...
  thread_mip_clocks[thread_id].timer_pointer_->stop(highs_timer_clock);
}
...
double HighsMipAnalysis::mipTimerRead(const HighsInt mip_clock,
  ...
  HighsInt highs_timer_clock = thread_mip_clocks[thread_id].clock_[mip_clock];
  return thread_mip_clocks[thread_id].timer_pointer_->read(highs_timer_clock);
}
