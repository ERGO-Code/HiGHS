...
void HighsPrimalHeuristics::trivial() {
  ...
  const std::vector<HighsInt>& continuous_cols = mipsolver.mipdata_->continuous_cols;
  ...
  const bool all_integer_boxed = all_integer_lower_finite && all_integer_upper_finite;
  /*
  printf(
