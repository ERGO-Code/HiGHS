...
void LuUpdate::BtranForUpdate(Int p) { _BtranForUpdate(p); }
...
bool LuUpdate::NeedFreshFactorization() { return _NeedFreshFactorization(); }

double LuUpdate::fill_factor() const { return _fill_factor(); }

double LuUpdate::pivottol() const { return _pivottol(); }

void LuUpdate::pivottol(double new_pivottol) { _pivottol(new_pivottol); }

Int LuUpdate::updates() const { return updates_; }
