...
public:
   ...
   */
  bool addRows(const int num_new_row, //!< Number of new rows
	       ...
	       const int *starts,     //!< Array of size num_new_row with start indices of the rows
	       const int *indices,    //!< Array of size num_new_nz with column indices for all rows
	       const double *values   //!< Array of size num_new_nz with column values for all rows
	       );

   /**
   * @brief Adds a column to the model
   */
  bool addCol(const double cost,    //!< Cost of the column
   ...
   */
  bool addCols(const int num_new_col, //!< Number of new columns
	       ...
	       const int num_new_nz,  //!< Number of new nonzeros
	       const int *starts,     //!< Array of size num_new_row with start indices of the columns
	       const int *indices,    //!< Array of size num_new_nz with row indices for all columns
	       const double *values   //!< Array of size num_new_nz with row values for all columns
	       );
  ...
  bool changeColsCost(
		      ...
		      const int* set,            //!< Array of size num_set_entries with indices of columns whose costs change
  ...
  bool changeColsBounds(
			const int num_set_entries, //!< The number of indides in the set
			const int* set,            //!< Array of size num_set_entries with indices of columns whose bounds change
			const double* lower,       //!< Array of size num_set_entries with new lower bounds
			const double* upper        //!< Array of size num_set_entries with new upper bounds
			);
  ...
  bool changeRowsBounds(
			const int num_set_entries, //!< The number of indides in the set
			const int* set,            //!< Array of size num_set_entries with indices of rows whose bounds change
			const double* lower,       //!< Array of size num_set_entries with new lower bounds
			const double* upper        //!< Array of size num_set_entries with new upper bounds
			);
   ...
   */
  bool getCols(
	       const int from_col,  //!< The index of the first column to get from the model
	       const int to_col,    //!< One more than the last column to get from the model
	       ...
	       int *matrix_start,   //!< Array of size num_col with start indices of the columns
  ...
  bool getCols(
	       const int num_set_entries, //!< The number of indides in the set
	       const int* set,            //!< Array of size num_set_entries with indices of columns to get
	       int& num_col,              //!< Number of columns got from the model
	       double *costs,             //!< Array of size num_col with costs
	       double *lower,             //!< Array of size num_col with lower bounds
	       double *upper,             //!< Array of size num_col with upper bounds
  ...
  bool getRows(
	       ...
	       int& num_nz,         //!< Number of nonzeros got from the model
	       int *matrix_start,   //!< Array of size num_row with start indices of the rows
	       int *matrix_index,   //!< Array of size num_nz with column indices for the rows
	       double *matrix_value //!< Array of size num_nz with column values for the rows
	       );
  ...
  bool getRows(
	       const int num_set_entries, //!< The number of indides in the set
	       const int* set,            //!< Array of size num_set_entries with indices of rows to get
	       int& num_row,              //!< Number of rows got from the model
	       double *lower,             //!< Array of size num_row with lower bounds
	       double *upper,             //!< Array of size num_row with upper bounds
	       int& num_nz,               //!< Number of nonzeros got from the model
   ...
   */
  bool deleteCols(
		  const int from_col, //!< The index of the first column to delete from the model
		  const int to_col    //!< One more than the last column to delete from the model
		  );
  ...
  bool deleteCols(
		  const int num_set_entries, //!< The number of indides in the set
		  const int* set             //!< Array of size num_set_entries with indices of columns to delete
		  );
   ...
   */
  bool deleteRows(
		  const int from_row, //!< The index of the first row to delete from the model
