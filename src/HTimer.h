...
public:
  HTimer() {
    ...
    itemNames[HTICK_ITERATE_CHUZR] = "CHUZR"; itemCh3Names[HTICK_ITERATE_CHUZR] = "CZR";
    itemNames[HTICK_ITERATE_CHUZC] = "CHUZC"; itemCh3Names[HTICK_ITERATE_CHUZC] = "CZC";
    itemNames[HTICK_ITERATE_FTRAN] = "FTRAN"; itemCh3Names[HTICK_ITERATE_FTRAN] = "FTR";
    ...
    itemNames[HTICK_PERM_WT] = "PERM_WT"; itemCh3Names[HTICK_PERM_WT] = "PWT";
    ...
    itemNames[HTICK_COLLECT_PR_IFS] = "COLLECT_PR_IFS"; itemCh3Names[HTICK_COLLECT_PR_IFS] = "IFS";
    itemNames[HTICK_COMPUTE_DUOBJ] = "COMPUTE_DUOBJ"; itemCh3Names[HTICK_COMPUTE_DUOBJ] = "DOB";
    itemNames[HTICK_REPORT_INVERT] = "REPORT_INVERT"; itemCh3Names[HTICK_REPORT_INVERT] = "RPI";
