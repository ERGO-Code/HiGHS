...
class HighsSparseMatrix {
 public:
  ...
  void addRows(const HighsSparseMatrix new_rows,
               const int8_t* in_partition = NULL);
  void getRow(const HighsInt iRow, HighsInt& num_nz, HighsInt* index, double* value);
  void getCol(const HighsInt iCol, HighsInt& num_nz, HighsInt* index, double* value);
