...
class HighsSparseMatrix {
 public:
  ...
  void alphaProductPlusY(const double alpha,
			 const std::vector<double>& x,
			 std::vector<double>& y,
			 const bool transpose = false) const;
  void product(vector<double>& result,
	       const vector<double>& x) const;
  void productTranspose(vector<double>&	result,
			const vector<double>& x) const;
  void productQuad(vector<double>& result,
