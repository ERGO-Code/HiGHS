...
HighsStatus writeModelAsMps(const HighsOptions& options,
  ...
  HighsStatus write_status = writeMps(
      ...
      lp.col_upper_, lp.row_lower_, lp.row_upper_, lp.a_matrix_.start_, lp.a_matrix_.index_,
      lp.a_matrix_.value_, hessian.q_start_, hessian.q_index_, hessian.q_value_,
