...
class SimplexTimer {
 public:
  void initialiseSimplexClocks(HighsModelObject & model_object) {
    ...
    simplex_info.clock_[SimplexPrimalPhase1Clock] = timer.clock_def("Primal Phase 1", "PP1");
    ...
    simplex_info.clock_[ChuzcPrimalClock] = timer.clock_def("CHUZC_PRIMAL", "CCP");
  ...
  void reportSimplexInnerClock(HighsModelObject & model_object) {
	...
	UpdateDualClock, UpdatePrimalClock, UpdateWeightClock, DevexIzClock, 
