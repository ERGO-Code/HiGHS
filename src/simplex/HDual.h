...
// Using 1 and 0 allows dvx_ix to be used as a multiplier to save a conditional
// branch
...
class HDual {
 ...
 public:
  ...
  double uOpRsDensityRec(double lc_OpRsDensity, double *opRsDensity,
                         double *opRsAvDensity, double *opRsAvLog10Density);
  ...
  bool alw_price_by_row_sw = true;  // By default allow switch to standard
                                    // row-wise PRICE if result is sufficiently
                                    // dense
