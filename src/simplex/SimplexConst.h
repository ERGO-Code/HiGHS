...
enum SimplexStrategy {
  ...
  SIMPLEX_STRATEGY_EKK,
  SIMPLEX_STRATEGY_MAX = SIMPLEX_STRATEGY_EKK,
...
enum RebuildReason {
  ...
  REBUILD_REASON_POSSIBLY_PRIMAL_UNBOUNDED,
  REBUILD_REASON_POSSIBLY_DUAL_UNBOUNDED,
  REBUILD_REASON_POSSIBLY_SINGULAR_BASIS,
  REBUILD_REASON_PRIMAL_INFEASIBLE_IN_PRIMAL_SIMPLEX,
  REBUILD_REASON_CHOOSE_COLUMN_FAIL,
