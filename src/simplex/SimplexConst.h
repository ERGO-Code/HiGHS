...
enum SimplexScaleStrategy {
  ...
  SIMPLEX_SCALE_STRATEGY_CHOOSE,
  SIMPLEX_SCALE_STRATEGY_HSOL,
  SIMPLEX_SCALE_STRATEGY_HIGHS,
  SIMPLEX_SCALE_STRATEGY_MAX = SIMPLEX_SCALE_STRATEGY_HIGHS
};
...
enum SimplexDualEdgeWeightStrategy {
  ...
  SIMPLEX_DUAL_EDGE_WEIGHT_STRATEGY_MAX = SIMPLEX_DUAL_EDGE_WEIGHT_STRATEGY_STEEPEST_EDGE_TO_DEVEX_SWITCH
};
