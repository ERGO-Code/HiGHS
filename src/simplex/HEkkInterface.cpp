...
void HEkk::appendColsToMatrix(const int num_new_col,
			      const int num_new_nz, const int* XAstart,
			      const int* XAindex, const double* XAvalue) {
  appendColsToLpMatrix(simplex_lp_, num_new_col, num_new_nz, XAstart, XAindex, XAvalue);
}

void HEkk::appendRowsToMatrix(const int num_new_row,
			      const int num_new_nz, const int* XARstart,
			      const int* XARindex, const double* XARvalue) {
  appendRowsToLpMatrix(simplex_lp_, num_new_row, num_new_nz, XARstart, XARindex, XARvalue);
}
