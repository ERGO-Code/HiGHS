...
enum HighsAnalysisLevel {
  ...
  HIGHS_ANALYSIS_LEVEL_MAX = HIGHS_ANALYSIS_LEVEL_MODEL_DATA + HIGHS_ANALYSIS_LEVEL_SOLVER_DATA + HIGHS_ANALYSIS_LEVEL_SOLVER_TIME + HIGHS_ANALYSIS_LEVEL_NLA_DATA + HIGHS_ANALYSIS_LEVEL_NLA_TIME
};
