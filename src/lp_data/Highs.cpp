...
#ifdef HiGHSDEV
  int current_highs_debug_level = options_.highs_debug_level;
  options_.highs_debug_level =
      HIGHS_DEBUG_LEVEL_CHEAP;  // HIGHS_DEBUG_LEVEL_MAX;  //
  if (options_.highs_debug_level != current_highs_debug_level)
    printf(
        "Highs::run() HiGHSDEV define so switching options_.highs_debug_level "
        "from %d to %d\n",
        current_highs_debug_level, options_.highs_debug_level);
#endif
