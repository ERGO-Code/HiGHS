 ...
 */
    const int dfSparseDaStr = -1; //!< Standard indices and full-length vector of values
...
/**
 * @brief Value used to indicate no pointer into the nonzero value array exitst for a particular entry when using 1-byte pointers
 */
    const unsigned char ilP1 =     255; //10;

/**
 * @brief Value used to indicate no pointer into the nonzero value array exitst for a particular entry when using 2-byte pointers
 */
 ...
 */
    ...
    map<int, double> packMap;        //!< Index-value pairs when using that ultra-sparse data structure
    vector<unsigned char> valueP1;   //!< 1-byte pointers when using that ultra-sparse data structure
    vector<unsigned short> valueP2;  //!< 2-byte pointers when using that ultra-sparse data structure
...
/**
 * @brief Packing: Zero values in Vector.array which exceed HSOL_CONST_TINY in magnitude
 *
 */
    void tight();
 ...
 */
    void copy(
	      const HVector *from //!< Source of HVector structure to be copied
	      );
 ...
 */
    void saxpy(
	       const double pivotX, //!< The multiple of *pivot to be added
