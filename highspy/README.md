...
When `highspy` is installed, HiGHS can be used to solve LP, MIP and QP.
...
MIT - see the [HiGHS repository](https://github.com/ERGO-Code/HiGHS) for details.
