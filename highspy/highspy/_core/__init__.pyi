...
from . import cb, simplex_constants
...
HighsIndexType: TypeAlias = int | _SupportsIndex
HighsFloatArrayType: TypeAlias = list[float] | numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]]
HighsIntArrayType: TypeAlias = list[int] | numpy.ndarray[typing.Any, numpy.dtype[numpy.int32]] | numpy.ndarray[typing.Any, numpy.dtype[numpy.int64]]
...
class _Highs:
    ...
    def passModel(
        ...
        nnz: int,
        qnnz: int,
        a_format: int | typing.SupportsInt,
        q_format: int | typing.SupportsInt,
        sense: int | typing.SupportsInt,
        offset: float,
    ...
    def setOptionValue(self, option_name: str, option_value: bool | float | str | typing.SupportsInt) -> HighsStatus: ...
    @typing.overload
