...
if (NOT APPLE AND NOT BUILD_OPENBLAS)
    ...
    if (WIN32)
      if(TARGET OpenBLAS::OpenBLAS)
          target_link_libraries(highs_extras PUBLIC OpenBLAS::OpenBLAS)
      elseif(OPENBLAS_LIB)
          message(STATUS "Linking against OpenBLAS via raw library: ${OPENBLAS_LIB}")
          target_link_libraries(highs_extras PUBLIC ${OPENBLAS_LIB})
          target_include_directories(highs_extras PUBLIC ${OPENBLAS_INCLUDE_DIR})
      elseif(TARGET BLAS::BLAS)
          ...
          target_link_libraries(highs_extras PUBLIC BLAS::BLAS)
      else()
